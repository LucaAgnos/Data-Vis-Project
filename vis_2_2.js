window.onload = function() {
  d3.csv("AGE_GENDER.csv").then(function(data) {
...
function barChart(data) {
  ...
  // Color scale for distinguishing M and F bars
  var colorScale = d3.scaleOrdinal()
    .domain(["M", "F"])
    .range(["steelblue", "salmon"]);

  // x scale linear is chosen to show linear representation for visualization
